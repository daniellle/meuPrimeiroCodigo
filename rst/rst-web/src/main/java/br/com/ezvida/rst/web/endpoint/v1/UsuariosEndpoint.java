...
public class UsuariosEndpoint extends SegurancaEndpoint<Usuario> {

    private static final long serialVersionUID = -3618279439764362012L;

	private static final Logger LOGGER = LoggerFactory.getLogger(UsuariosEndpoint.class);
	...
	public Response alterar(@Encoded br.com.ezvida.girst.apiclient.model.Usuario usuario, @Context SecurityContext context,
			@Context HttpServletRequest request) {
        return Response.status(HttpServletResponse.SC_CREATED).entity(serializar(usuarioService.alterarUsuario(usuario,
