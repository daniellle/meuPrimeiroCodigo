...
public class SindicatosEndpoint extends SegurancaEndpoint<Sindicato> {

	private static final long serialVersionUID = -5242832488603150874L;
	
	private static final Logger LOGGER = LoggerFactory.getLogger(SindicatosEndpoint.class);
