...
import br.com.ezvida.rst.service.UatQuadroPessoalService;
...
@RequestScoped
@Path("/private/v1/uatquadropessoal")
public class UatQuadroPessoalEndPoint extends SegurancaEndpoint<UatQuadroPessoal> {

    private static final long serialVersionUID = -3795693590899960123L;
    ...
    public Response salvar(@Encoded List<UatQuadroPessoal> listUatQuadrosPessoais, @Context SecurityContext context
        , @Context HttpServletRequest request) {
        getResponse().setCharacterEncoding(StandardCharsets.UTF_8.displayName());
        return Response.status(HttpServletResponse.SC_OK)
            .entity(this.uatQuadroPessoalService.salvar(listUatQuadrosPessoais,
    ...
    public Response findByUnidade(@PathParam("idUnidade") Long idUnidade, @Context SecurityContext context
        ...
        return Response.status(HttpServletResponse.SC_OK).type(MediaType.APPLICATION_JSON)
            ...
            .entity(serializar(this.uatQuadroPessoalService.findByUnidade(idUnidade,
                ClienteInfos.getClienteInfos(context, request,
    ...
    public Response desativar(@PathParam("id") Long id, @PathParam("idUnidade") Long idUnidade, @Context SecurityContext context
        , @Context HttpServletRequest request) {
        try {
            this.uatQuadroPessoalService.desativar(id, idUnidade,
                ClienteInfos.getClienteInfos(context, request,
                    TipoOperacaoAuditoria.CONSULTA, Funcionalidade.GESTAO_UNIDADE_SESI),
