...
public class UnidadeAtendimentoTrabalhadorDAO extends BaseDAO<UnidadeAtendimentoTrabalhador, Long> {
    ...
    public List<UnidadeAtendimentoTrabalhador> buscaTodasPorEmpresa(Long idEmpresa) {
        StringBuilder jpql = new StringBuilder();
        jpql.append(" SELECT distinct uat.no_cnpj, uat.ds_razao_social, uat.nm_fantasia, dr.no_cnpj as dr_cnpj, dr.ds_razao_social as dr_razao_social, dr.sigla_dr FROM und_atd_trabalhador uat ");
