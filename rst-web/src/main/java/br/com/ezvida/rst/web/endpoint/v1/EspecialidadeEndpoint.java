...
public class EspecialidadeEndpoint extends SegurancaEndpoint<Estado>{

	private static final long serialVersionUID = -4517036985330716937L;

	private static final Logger LOGGER = LoggerFactory.getLogger(EspecialidadeEndpoint.class);
